...
namespace YAM
{
    ...
    Syntax:
        ...
        BuildFile => [Dependencies] {Rule}*

        Dependencies => 'deps' '{' {Dependency}* '}'
        Dependency => BuildFile | DepGlob
    ...
    RepoPath: a symbolic path in one of the configured repositories. A symbolic
    path represents an absolute path name on a repository. In a symbolic path
    the repository root directory is replaced by the repository name. This 
    allows repositories to be moved to other directories without having to 
    modify build files.
