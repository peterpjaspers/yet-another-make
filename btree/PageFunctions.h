...
namespace BTree {
    ...
    // Copy a contiguous number of objects of type T.
    // Objects of type T must be copyable.
    // Source and destination arrays and/or objects may overlap.
    template <class T>
    ...
    // When shifting multiple page content, care must be taken to copy content in correct order.
    ...
    public:
        ...
        static void pageSplit(
            ...
            if ((page.header.split != 1) || (&page != &dst)) {
                K* k = page.keys();
                V* v = page.values();
        ...
        // Exchange a scalar key scalar value pair at an index
        template <class K, class V>
        static void pageExchange(
            const Page<K, V, false, false>& page,
            Page<K, V, false, false>& dst,
            PageIndex index,
            const K& key,
        ...
        // Exchange an array key scalar value pair at an index
        template <class K, class V>
        static void pageExchange(
            const Page<K, V, true, false>& page,
            Page<K, V, true, false>& dst,
        ...
        // Exchange a scalar key array value pair at an index
        template <class K, class V>
        static void pageExchange(
            const Page<K, V, false, true>& page,
            Page<K, V, false, true>& dst,
        ...
        // Exchange an array key array value pair at an index
        template <class K, class V>
        static void pageExchange(
            const Page<K, V, true, true>& page,
            Page<K, V, true, true>& dst,
        ...
        // Shift page content from indexed pair up to last pair to lower pairs in another page
        template <class K, class V>
        ...
        static void pageShiftRight(
            ...
            copy<V>(&dstRight.splitValue(), &rsv, dstRight.header.split);
